using System;
using CodeBrix.Cryptography.Pqc.Crypto.Ntru.ParameterSets;

namespace CodeBrix.Cryptography.Pqc.Crypto.Ntru.Polynomials; //was previously: Org.BouncyCastle.Pqc.Crypto.Ntru.Polynomials;

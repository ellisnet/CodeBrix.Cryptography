...
namespace CodeBrix.Cryptography.Pqc.Crypto.Cmce; //was previously: Org.BouncyCastle.Pqc.Crypto.Cmce;
    ...
    where GFImpl : struct, GF
{
    ...
    {
        if (CodeBrix.Cryptography.Runtime.Intrinsics.X86.Bmi1.X64.IsEnabled)
        {

...
using CodeBrix.Cryptography.Math.EC.Custom.GM;
using CodeBrix.Cryptography.Math.EC.Custom.Sec;
using CodeBrix.Cryptography.Math.EC.Endo;
...
namespace CodeBrix.Cryptography.Crypto.EC; //was previously: Org.BouncyCastle.Crypto.EC;

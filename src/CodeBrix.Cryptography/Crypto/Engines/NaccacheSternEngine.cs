	...
	: IAsymmetricBlockCipher
{
	...
	*
	* @see CodeBrix.Cryptography.Crypto.AsymmetricBlockCipher#init(bool,
	*      CodeBrix.Cryptography.Crypto.CipherParameters)
	*/
	...
	*
	* @see CodeBrix.Cryptography.Crypto.AsymmetricBlockCipher#GetInputBlockSize()
	*/
...
//				return key.Modulus.ToByteArray().Length;
	...
	*
	* @see CodeBrix.Cryptography.Crypto.AsymmetricBlockCipher#GetOutputBlockSize()
	*/
...
//				return key.Modulus.ToByteArray().Length;
	...
	*
	* @see CodeBrix.Cryptography.Crypto.AsymmetricBlockCipher#ProcessBlock(byte[],
	*      int, int)
	*/

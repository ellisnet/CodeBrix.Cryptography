...
namespace CodeBrix.Cryptography.Crypto.Agreement.JPake; //was previously: Org.BouncyCastle.Crypto.Agreement.JPake;
...
public class JPakeRound3Payload
{
    ...
    ///
    /// See JPAKEUtil#calculateMacTag(string, string, BigInteger, BigInteger, BigInteger, BigInteger, BigInteger, CodeBrix.Cryptography.Crypto.Digest)
    /// </summary>

    ...
    : IMac
{
    ...
    /// <summary>
    /// Initialises the GMAC - requires a <see cref="CodeBrix.Cryptography.Crypto.Parameters.ParametersWithIV"/>
    /// providing a <see cref="CodeBrix.Cryptography.Crypto.Parameters.KeyParameter"/> and a nonce.
    /// </summary>

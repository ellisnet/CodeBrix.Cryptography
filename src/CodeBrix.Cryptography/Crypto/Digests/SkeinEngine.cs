...
/// sizes, based on the <see cref="CodeBrix.Cryptography.Crypto.Engines.ThreefishEngine">Threefish</see> tweakable block cipher.
/// </summary>
/// <remarks>
...
/// <p/>
/// This implementation is the basis for <see cref="CodeBrix.Cryptography.Crypto.Digests.SkeinDigest"/> and <see cref="CodeBrix.Cryptography.Crypto.Macs.SkeinMac"/>, implementing the
/// parameter based configuration system that allows Skein to be adapted to multiple applications. <br/>
/// Initialising the engine with <see cref="CodeBrix.Cryptography.Crypto.Parameters.SkeinParameters"/> allows standard and arbitrary parameters to
...
/// </ul>
/// </remarks>
/// <seealso cref="CodeBrix.Cryptography.Crypto.Parameters.SkeinParameters"/>
    ...
    : IMemoable
{
    ...
    /// <summary>
    /// Initialises the Skein engine with the provided parameters. See <see cref="CodeBrix.Cryptography.Crypto.Parameters.SkeinParameters"/> for

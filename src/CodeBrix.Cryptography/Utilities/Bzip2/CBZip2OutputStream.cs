...
/*
 * MODIFICATION NOTICE: this file has been modified from the Apache Ant original.
 * BouncyCastle.NET translated it from Java (org.apache.tools.bzip2) to C#, and
 * CodeBrix.Cryptography further changed it: the namespace was renamed from
 * Org.BouncyCastle.Utilities.Bzip2 to CodeBrix.Cryptography.Utilities.Bzip2, the
 * block-scoped namespace was converted to a file-scoped one, and framework-selection
 * preprocessor branches were resolved for a net10.0-only build.
 */
...
namespace CodeBrix.Cryptography.Utilities.Bzip2; //was previously: Org.BouncyCastle.Utilities.Bzip2;

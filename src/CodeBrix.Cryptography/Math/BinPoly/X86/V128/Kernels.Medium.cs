...
namespace CodeBrix.Cryptography.Math.BinPoly.X86.V128; //was previously: Org.BouncyCastle.Math.BinPoly.X86.V128;
...
internal static partial class Kernels
{
    ...
    /// <c>CodeBrix.Cryptography.Math.BinPoly.Scalar.Kernels.ImplMul</c> arbitrary-degree

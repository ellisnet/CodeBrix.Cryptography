...
namespace CodeBrix.Cryptography.Math.BinPoly; //was previously: Org.BouncyCastle.Math.BinPoly;
...
/// <see cref="CodeBrix.Cryptography.Runtime.Intrinsics.X86.Pclmulqdq"/>), otherwise over words with a

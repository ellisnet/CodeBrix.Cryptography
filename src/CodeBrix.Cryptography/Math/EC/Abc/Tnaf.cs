...
namespace CodeBrix.Cryptography.Math.EC.Abc; //was previously: Org.BouncyCastle.Math.EC.Abc;
...
internal static class Tnaf
{
    ...
    */
    ...
    /**
    * Multiplies a {@link CodeBrix.Cryptography.Math.EC.AbstractF2mPoint AbstractF2mPoint}

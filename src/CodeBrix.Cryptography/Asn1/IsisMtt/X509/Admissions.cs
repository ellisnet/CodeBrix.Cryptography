...
namespace CodeBrix.Cryptography.Asn1.IsisMtt.X509; //was previously: Org.BouncyCastle.Asn1.IsisMtt.X509;
...
* </pre>
*
* @see CodeBrix.Cryptography.Asn1.IsisMtt.X509.AdmissionSyntax
* @see CodeBrix.Cryptography.Asn1.IsisMtt.X509.ProfessionInfo
* @see CodeBrix.Cryptography.Asn1.IsisMtt.X509.NamingAuthority
*/

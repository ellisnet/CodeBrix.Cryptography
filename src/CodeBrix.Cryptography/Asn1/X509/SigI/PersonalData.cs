...
namespace CodeBrix.Cryptography.Asn1.X509.SigI; //was previously: Org.BouncyCastle.Asn1.X509.SigI;
...
* </pre>
*
* @see CodeBrix.Cryptography.Asn1.X509.sigi.NameOrPseudonym
* @see CodeBrix.Cryptography.Asn1.X509.sigi.SigIObjectIdentifiers
*/

================================================================================
README-INDEX: CodeBrix.Cryptography
...
------------------------------------------------------------------
  AGENT-README.txt
      CodeBrix.Cryptography.MitLicenseForever — a fully managed, dependency-free
      general-purpose cryptography library: ciphers, digests, MACs, signatures,
      key agreement, KDFs, post-quantum algorithms, TLS/DTLS, OpenPGP, CMS,
      PKCS, X.509, PKIX, OCSP, TSP, CMP, CRMF and PEM interoperability.

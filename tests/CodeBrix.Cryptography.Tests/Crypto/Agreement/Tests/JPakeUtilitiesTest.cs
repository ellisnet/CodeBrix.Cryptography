    ...
    : SimpleTest
{
    ...
    internal void TestValidateParticipantIdsDiffer()
    {
    ...
    internal void TestValidateParticipantsIdsEqual()
    {
    ...
    internal void TestValidateMacTag()
    {
    ...
    internal void TestValidateNotNull()
    {
    ...
    internal void TestValidateZeroKnowledgeProof()
    {
        JPakePrimeOrderGroup pg1 = JPakePrimeOrderGroups.SUN_JCE_1024;

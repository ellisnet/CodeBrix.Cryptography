...
public class GcmReorderTest
{
	...
	public void TestCombine()
	{
		for (int count = 0; count < 10; ++count)
		{
			...
			Assert.True(Arrays.AreEqual(ghashAC, ghashCombine));
		}
	}
	...
	public void TestConcatAuth()
	{
		for (int count = 0; count < 10; ++count)
		{
			...
			Assert.True(Arrays.AreEqual(ghashPA_val, ghashConcat));
		}
	}
	...
	public void TestConcatCrypt()
	{
		for (int count = 0; count < 10; ++count)
		{
			...
			Assert.True(Arrays.AreEqual(ghash_PA, ghashConcat));
		}
	}
	...
	{
		{
			...
			for (int pow = 0; pow != 100; ++pow)
			{
				...
				Assert.True(Arrays.AreEqual(buf1, buf2));
		...
		for (int i = 0; i != 10; ++i)
		{
			...
			Assert.True(Arrays.AreEqual(expected, actual));
		}
	}
	...
	public void TestMultiply()
	{
		...
		Assert.True(Arrays.AreEqual(expected, multiply(H, H)));
		...
		for (int count = 0; count < 10; ++count)
		{
			...
			mul.MultiplyH(expected);
			Assert.True(Arrays.AreEqual(expected, multiply(a, H)));
			Assert.True(Arrays.AreEqual(expected, multiply(H, a)));

			expected = Arrays.Clone(b);
			mul.MultiplyH(expected);
			Assert.True(Arrays.AreEqual(expected, multiply(b, H)));
			Assert.True(Arrays.AreEqual(expected, multiply(H, b)));

			Assert.True(Arrays.AreEqual(multiply(a, b), multiply(b, a)));
		}
	}

    ...
    : SimpleTest
{
    ...
    public override void PerformTest()
    {
        ...
        Assert.True(Arrays.AreEqual(Hex.Decode("c1c36925b6409a04f1b504fcbca9d82b4017277cb5ed2b2065fc1d3814d5aaf5"), res));
      ...
      "000102030405060708090A0B0C0D0E0F" +
        ...
        Assert.True(Arrays.AreEqual(Hex.Decode("C5221D50E4F822D96A2E8881A961420F294B7B24FE3D2094BAED2C6524CC166B "), res));
        ...
        Assert.True(Arrays.AreEqual(Hex.Decode(
   "D008828E2B80AC9D2218FFEE1D070C48" +
    ...
    private void checkZeroPadZ()
    {
        ...
        Assert.True(Arrays.AreEqual(Hex.Decode("6e393540387004f087c4180db008acf6825190cf"), buf));

        CShakeDigest cshake2 = new CShakeDigest(128, new byte[0], new byte[329]);
        cshake2.Output(buf, 0, buf.Length);
        Assert.True(Arrays.AreEqual(Hex.Decode("309bd7c285fcf8b839c9686b2cc00bd578947bee"), buf));

        cshake2 = new CShakeDigest(128, new byte[29], new byte[300]);
        cshake2.Output(buf, 0, buf.Length);
        Assert.True(Arrays.AreEqual(Hex.Decode("ff6aafd83b8d22fc3e2e9b9948b581967ed9c5e7"), buf));
    }
    ...
    private void doFinalTest()
    {
        ...
        Assert.True(Arrays.AreEqual(Hex.Decode("9cbce830079c452abdeb875366a49ebfe75b89ef17396e34898e904830b0e136"), res));
    }
    ...
    private void longBlockTest()
    {
        ...
        Assert.True(Arrays.AreEqual(Hex.Decode("4a899b5be460d85a9789215bc17f88b8f8ac049bd3b519f561e7b5d3870dafa3"), res));
    }

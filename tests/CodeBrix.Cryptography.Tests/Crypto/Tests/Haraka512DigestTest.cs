...
public class Haraka512DigestTest : SimpleTest
{
    ...
    internal void TestKnownVector()
    {
        ...
        Assert.True(Arrays.AreEqual(expected512, output));
    }
    ...
    internal void TestInputTooShort()
    {
        ...
        {
            Assert.True(Contains(e.Message, "input must be exactly 64 bytes"));
        }
    }
    ...
    internal void TestInputTooLong()
    {
        ...
        {
            Assert.True(Contains(e.Message, "total input cannot be more than 64 bytes"));
        }
    }

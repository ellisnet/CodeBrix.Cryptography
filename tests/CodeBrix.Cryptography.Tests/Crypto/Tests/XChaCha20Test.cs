...
public class XChaCha20Test
{
    ...
    public void HChaCha20Vector()
    {
        ...
        Assert.True(Arrays.AreEqual(streamFromXChaCha, streamFromChaCha), "HChaCha20 subkey derivation does not match draft test vector");
    }
    ...
    public void DraftStreamVector()
    {
        ...
        Assert.True(Arrays.AreEqual(input, roundTrip), "XChaCha20 round-trip mismatch");
    }
    ...
    public void RandomRoundTrip()
    {
        ...
        for (int i = 0; i < 50; ++i)
        {
            ...
            Assert.True(Arrays.AreEqual(plain, back), "XChaCha20 randomized round-trip failed at length " + len);
        }
    }
    ...
    public void ChunkedProcessing()
    {
        ...
        foreach (int chunk in splits)
        {
            ...
            Assert.True(Arrays.AreEqual(whole, piecewise), "chunked processing differs from bulk at chunk size " + chunk);
        }
    }

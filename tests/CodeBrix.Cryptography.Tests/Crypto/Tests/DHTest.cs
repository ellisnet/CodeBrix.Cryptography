...
public class DHTest
{
    ...
    private void CheckKeySize(int privateValueSize, DHPrivateKeyParameters priv)
    {
        ...
        {
            Assert.Equal(privateValueSize, priv.X.BitLength);
        }
    }
    ...
    public void ModulusSizeBound()
    {
        ...
        {
            Assert.True(e.Message.StartsWith("DH modulus out of range"), "unexpected DH message: " + e.Message);
        }

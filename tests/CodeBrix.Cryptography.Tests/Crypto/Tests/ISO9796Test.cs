...
public class ISO9796Test
{
    ...
    public virtual void Test1()
    {
        ...
        Assert.True(Arrays.AreEqual(sig1, data), "failed ISO9796-1 generation Test 1");

        data = eng.ProcessBlock(data, 0, data.Length);

        Assert.True(Arrays.AreEqual(msg1, data), "failed ISO9796-1 retrieve Test 1");
    }
    ...
    public virtual void Test2()
    {
        ...
        Assert.True(IsSameAs(data, 1, sig2), "failed ISO9796-1 generation Test 2");

        data = eng.ProcessBlock(data, 0, data.Length);

        Assert.True(Arrays.AreEqual(msg2, data), "failed ISO9796-1 retrieve Test 2");
    }
    ...
    public virtual void Test3()
    {
        ...
        Assert.True(IsSameAs(sig3, 1, data), "failed ISO9796-1 generation Test 3");

        data = eng.ProcessBlock(data, 0, data.Length);

        Assert.True(IsSameAs(msg3, 0, data), "failed ISO9796-1 retrieve Test 3");
    }
    ...
    public virtual void Test4()
    {
        ...
        Assert.True(IsSameAs(sig4, 0, data), "failed ISO9796-2 generation Test 4");
        ...
        Assert.True(eng.HasFullMessage(), "full message flag false - Test 4");
        ...
        Assert.True(IsSameAs(eng.GetRecoveredMessage(), 0, msg4), "failed ISO9796-2 recovered message Test 4");

        // try update with recovered
        eng.UpdateWithRecoveredMessage(sig4);

        Assert.True(IsSameAs(eng.GetRecoveredMessage(), 0, msg4), "failed ISO9796-2 updateWithRecovered recovered message Test 4");

        Assert.True(eng.VerifySignature(sig4), "failed ISO9796-2 updateWithRecovered verify and recover Test 4");

        Assert.True(IsSameAs(eng.GetRecoveredMessage(), 0, msg4), "failed ISO9796-2 updateWithRecovered recovered verify message Test 4");
        ...
        Assert.False(eng.VerifySignature(sig4), "failed ISO9796-2 updateWithRecovered verify and recover Test 4");
    }
    ...
    public virtual void Test5()
    {
        ...
        Assert.True(IsSameAs(sig5, 0, data), "failed ISO9796-2 generation Test 5");
    ...
    public virtual void Test6()
    {
        ...
        Assert.True(IsSameAs(sig6, 1, data), "failed ISO9796-2 generation Test 6");
    ...
    public virtual void Test7()
    {
        ...
        Assert.True(IsSameAs(sig7, 0, data), "failed ISO9796-2 generation Test 7");
        ...
        Assert.True(IsSameAs(msg7, 0, eng.GetRecoveredMessage()), "failed ISO9796-2 recovery Test 7");
    }
    ...
    public virtual void Test8()
    {
        ...
        Assert.True(IsSameAs(sig8, 0, data), "failed ISO9796-2 generation Test 8");
    ...
    public virtual void Test9()
    {
        ...
        Assert.True(IsSameAs(sig9, 0, data), "failed ISO9796-2 generation Test 9");
    ...
    public void Test13()
    {
        ...
        Assert.True(Arrays.AreEqual(nonce, recoverableMessage), "Nonce compare with recoverable part of message failed");
    }
    ...
    public void ShortPartial()
    {
        ...
        Assert.True(Arrays.AreEqual(recovered, mm), "short partial PSS recovery failed");
    }
    ...
    public void FullMessage()
    {
        ...
        Assert.True(pssSign.VerifySignature(sig), "challenge PSS sig verification failed.");

        byte[] mm = pssSign.GetRecoveredMessage();

        Assert.True(Arrays.AreEqual(challenge, mm), "challenge partial PSS recovery failed");
    }
    ...
    public void MalformedSignature()
    {
        ...
        for (int i = 0; i != malformed.Length; i++)
        {
            ...
            Assert.False(verifier.VerifySignature(malformed[i]), "Iso9796d2Signer accepted a malformed signature of length " + malformed[i].Length);
        }

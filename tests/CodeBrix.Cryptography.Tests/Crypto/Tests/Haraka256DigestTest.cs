...
public class Haraka256DigestTest : SimpleTest
{
    ...
    internal void TestKnownVector()
    {
        ...
        Assert.True(Arrays.AreEqual(expected256, output));
    }

    internal void TestInputTooShort()
    {
        try
        {
            Haraka256Digest haraka = new Haraka256Digest();
        ...
        {
            Assert.True(Contains(e.Message, "input must be exactly 32 bytes"));
        }
    }

    internal void TestInputTooLong()
    {
        try
        {
            Haraka256Digest haraka = new Haraka256Digest();
        ...
        {
            Assert.True(Contains(e.Message, "total input cannot be more than 32 bytes"));
        }
    }
    ...
    internal void TestOutput()
    {
        ...
        {
            Assert.True(Contains(e.Message, "output too short to receive digest"));
        }
    ...
    void TestMonty()
    {
        ...
        for (int i = 0; i != vectors.Length; i++)
        {
            ...
            Assert.True(Arrays.AreEqual(expected, result));

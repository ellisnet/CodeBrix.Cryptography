...
public class MLKemTest
{
    ...
    public static IEnumerable<object[]> DecapFiles_Data => DecapFiles.Select(v => new object[] { v });
    ...
    public static IEnumerable<object[]> ModulusFiles_Data => ModulusFiles.Select(v => new object[] { v });
    ...
    [MemberData(nameof(DecapFiles_Data))]
    ...
    [Theory(Skip = BcTestData.SkipReason, SkipUnless = nameof(BcTestData.IsAvailable), SkipType = typeof(BcTestData))]
    [MemberData(nameof(ModulusFiles_Data))]
        ...
        MLKemPrivateKeyParameters.Format format)
    {
        ...
        {
            Assert.Same(privateKey, updatedPrivateKey);
        }
    }

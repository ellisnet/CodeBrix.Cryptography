...
public class SignedDataStreamTest
{
	...
	public void TestSha1WithRsa()
	{
		...
		Assert.Contains(SignCrl, col);
		Assert.Contains(OrigCrl, col);
	}
    ...
    public void TestCrlAndOtherRevocationInfoFormat()
    {
        ...
        Assert.Equal(2, crls.Count);
        Assert.Contains(SignCrl, crls);
        Assert.Contains(OrigCrl, crls);
	...
	public void TestSha1WithRsaNonData()
	{
		...
		Assert.Equal("1.2.3.4", stream.ContentType);
	...
	public void TestSha1WithRsaEncapsulated()
	{
        ...
        Assert.Single(sd.GetSignerInfos().GetSigners());
	...
	private void CheckAttribute(byte[] expected, Asn1.Cms.Attribute	attr)
	{
        ...
        Assert.Equal(new DerOctetString(expected), value);
	}

...
public class CompressedDataTest
{
    ...
    public void TestWorkingData()
    {
        ...
        Assert.True(Arrays.AreEqual(uncompData, ed.GetContent()));
    }
    ...
    public void TestEach()
    {
        ...
        Assert.Equal(PkcsObjectIdentifiers.Data, cd.CompressedContentType);

        using (var contentStream = cd.GetContentStream())
        {
            Assert.Equal(PkcsObjectIdentifiers.Data, contentStream.ContentTypeOid);
        }

        Assert.True(Arrays.AreEqual(TestData, cd.GetContent()));
    }
    ...
    public void TestContentType()
    {
        ...
        Assert.Equal(PkcsObjectIdentifiers.SafeContentsBag, cd.CompressedContentType);

        using (var contentStream = cd.GetContentStream())
        {
            Assert.Equal(PkcsObjectIdentifiers.SafeContentsBag, contentStream.ContentTypeOid);
        }
    ...
    public void TestLimitUnder()
    {
        ...
        {
            Assert.True(e.InnerException is StreamOverflowException);
        }
    }
    ...
    public void TestLimitOver()
    {
        ...
        Assert.True(Arrays.AreEqual(TestData, cd.GetContent(TestData.Length * 2)));
    }
    ...
    public void TestLimitEqual()
    {
        ...
        Assert.True(Arrays.AreEqual(TestData, cd.GetContent(TestData.Length)));
    }

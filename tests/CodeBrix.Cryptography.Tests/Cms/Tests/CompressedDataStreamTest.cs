...
public class CompressedDataStreamTest
{
	...
	public void TestWorkingData()
	{
		...
		Assert.True(Arrays.AreEqual(uncompData, CmsTestUtil.StreamToByteArray(ed.GetContent().ContentStream)));
	}
	...
	public void TestEach()
	{
		...
		Assert.True(Arrays.AreEqual(testData, CmsTestUtil.StreamToByteArray(ed.GetContent().ContentStream)));
	}

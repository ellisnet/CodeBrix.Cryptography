...
namespace CodeBrix.Cryptography.Math.EC.Rfc7748.Tests; //was previously: Org.BouncyCastle.Math.EC.Rfc7748.Tests;
...
public class X25519Test
{
    ...
    public void TestConsistency()
    {
        ...
        for (int i = 1; i <= 100; ++i)
        {
            ...
            Assert.True(Arrays.AreEqual(rF, rV), "Consistency #" + i);
        }
    }
    ...
    public void TestECDH()
    {
        ...
        for (int i = 1; i <= 100; ++i)
        {
            ...
            Assert.True(rA == rB && Arrays.AreEqual(sA, sB), "ECDH #" + i);
        }
    }
    ...
    private static void CheckECDHVector(string sA, string sAPub, string sB, string sBPub, string sK, string text)
    {
        ...
        Assert.Equal(X25519.ScalarSize, a.Length);

        byte[] b = Hex.Decode(sB);
        Assert.Equal(X25519.ScalarSize, b.Length);
    ...
    {
        Assert.Equal(X25519.PointSize, X25519.ScalarSize);

...
public class PgpAeadTest
{
    ...
    public void PaddingKnownBytes()
    {
        ...
        Assert.True(Arrays.AreEqual(known, packet.GetPadding()));
    }
    ...
    public void PaddingRandom50Bytes()
    {
        ...
        Assert.Equal(50, packet.GetPadding().Length);
    }
    ...
    public void PaddingPacketEncoding()
    {
        ...
        using (MemoryStream bIn = new MemoryStream(bOut.ToArray(), writable: false))
        {
            ...
            Assert.True(Arrays.AreEqual(packet.GetPadding(), padding.GetPadding()));
        }
    }
    ...
    public void PreferredAeadAlgorithmsImplicitlySupportAes128Ocb()
    {
        ...
        //Assert.True(Arrays.AreEqual(new PreferredAEADCiphersuites.Combination[0], preferences.getRawAlgorithms()));
        //Assert.True(Arrays.AreEqual(new PreferredAEADCiphersuites.Combination[]{implicit}, preferences.getAlgorithms()));
    }
    ...
    public void PreferredAeadAlgorithmsRoundtrip()
    {
        ...
        //Assert.True(Arrays.AreEqual(preferences.getRawAlgorithms(), parsed.getRawAlgorithms()));
    }
    ...
    private void ImplTestDecryption(string armoredMessage, char[] password, byte[] expectedPlaintext)
    {
        ...
        for (int i = 0; i < encryptedDataList.Count; i++)
        {
            if (encryptedDataList[i] is PgpPbeEncryptedData symEncData)
            {
                ...
                Assert.True(Arrays.AreEqual(expectedPlaintext, plaintextOut.ToArray()));

...
public class ArmoredOutputStreamInjectionTest
{
    ...
    public void All()
    {
        ...
        Assert.True(Arrays.AreEqual(data, recovered), "armored round-trip with an embedded CR in a comment failed");
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        catch (ArgumentException e)
        {
            ...
            Assert.Equal("armor header must not contain CR/LF", e.Message);
        }

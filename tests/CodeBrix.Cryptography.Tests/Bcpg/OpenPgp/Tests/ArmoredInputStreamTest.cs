...
public class ArmoredInputStreamTest
{
    ...
    public void BogusHeaders()
    {
        ...
        {
            Assert.Equal("invalid armor", e.Message);
        }
        ...
        {
            Assert.Equal("invalid armor header", e.Message);
        }
    ...
    public void BackslashTrvf()
    {
        ...
        {
            Assert.Fail(string.Format("Cannot parse armor containing blank line with '\\t\\r\\v\\f'.", e));
        }
    }
    ...
    public void CrcErrorGetsThrown()
    {
        ...
        {
            Assert.Equal("crc check failed in armored message.", e.Message);
        }
    }
    ...
    public void IgnoreMissingCrc()
    {
        ...
        {
            Assert.Fail(string.Format("Missing CRC sum must be ignored.", e));
        }
        ...
        {
            Assert.Equal("crc check not found", e.Message);
            // expected
        }
    }

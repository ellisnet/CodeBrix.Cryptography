...
public class Argon2S2kTest
{
    ...
    //    {
    //        Assert.Equal("memory size exponent out of range", e.Message);
    //    }
    //}
    ...
    public void Encoding()
    {
        ...
        Assert.Equal(S2k.Argon2, argon2.Type);
        Assert.Equal(1, argon2.Argon2Config.Passes);
        Assert.Equal(4, argon2.Argon2Config.Parallelism);
        Assert.Equal(21, argon2.Argon2Config.MemorySizeExponent);
        Assert.Equal(16, argon2.Argon2Config.GetSalt().Length);
        ...
        Assert.Equal(20, encoding.Length);
        Assert.Equal(0x04, encoding[0]);    // Type is Argon2
        Assert.Equal(0x01, encoding[17]);   // 1 pass
        Assert.Equal(0x04, encoding[18]);   // 4 parallelism
        Assert.Equal(0x15, encoding[19]);   // 0x15 = 21 mem exp
    }
    ...
    public void DecryptAes128Message()
    {
        ...
        Assert.Equal(TestMsgPlain, plaintext);
    }

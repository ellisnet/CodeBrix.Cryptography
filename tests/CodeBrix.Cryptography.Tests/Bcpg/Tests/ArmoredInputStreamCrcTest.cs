...
public class ArmoredInputStreamCrcTest
{
    ...
    public void WellFormedArmorStillRoundTrips()
    {
        ...
        Assert.True(Arrays.AreEqual(data, recovered), "armored round trip");
        ...
        Assert.True(Arrays.AreEqual(Arrays.Concatenate(data, data), both), "two messages");
    }

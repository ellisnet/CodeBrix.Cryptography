...
public class NistCertPathTest
{
    ...
    public void TestInvalidCANotAfterDateTest5()
    {
        DoExceptionTest(TRUST_ANCHOR_ROOT_CERTIFICATE,
            ...
            1,
            "Could not validate certificate: certificate expired on 20110101083000Z");
    }
        ...
        string mesEnd)
    {
        ...
        {
            Assert.Equal(index, e.Index);
            Assert.StartsWith(mesStart, e.Message);
            Assert.EndsWith(mesEnd, e.Message);
        }
    }
        ...
        ISet<string> policies)
    {
        ...
        // PKITS 2011 edition: fixtures are valid 2010-01-01 08:30Z to 2030-12-31 08:30Z,
        // and the deliberately-expired ones run out at 2011-01-01 08:30Z. Upstream pins
        // 1/1/2011, which suits the 2001 edition but leaves those certs still valid here.
        parameters.Date = DateTime.Parse("1/1/2020");

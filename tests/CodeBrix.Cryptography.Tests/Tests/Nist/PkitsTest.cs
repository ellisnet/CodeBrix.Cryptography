...
internal class PkitsTest
{
    ...
    internal PkixCertPathValidatorResult DoTest()
    {
        ...
        // PKITS 2011 edition: the fixtures are valid 2010-01-01 08:30Z to 2030-12-31 08:30Z.


        // Upstream pins 1/1/2010, which suits the 2001 edition (valid 2001-2011) but falls


        // before this edition's notBefore, so every path failed "not yet valid".


        pkixParams.Date = DateTime.Parse("1/1/2020");

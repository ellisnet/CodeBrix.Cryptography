...
using CodeBrix.Cryptography.Tls.Tests;
using CodeBrix.Cryptography.Utilities;
using Xunit;

namespace CodeBrix.Cryptography.Tls.Crypto.Tests; //was previously: Org.BouncyCastle.Tls.Crypto.Tests;
...
public class BcTlsCryptoTest
{
    ...
    public void TestDHExplicit()
    {
        ...
        foreach (DHGroup dhGroup in groups)
        {
             ...
             */
            Assert.Same(dhGroup, TlsDHUtilities.GetStandardGroupForDHParameters(p, g));
    ...
    private static void AssertArrayEquals(byte[] a, byte[] b) => Assert.True(Arrays.AreEqual(a, b));

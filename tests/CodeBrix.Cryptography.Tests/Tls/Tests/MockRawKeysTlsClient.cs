    ...
    : DefaultTlsClient
{
        ...
        : TlsAuthentication
    {
        ...
        {
            Assert.Equal(m_outer.m_serverCertType, serverCertificate.Certificate.CertificateType);
        }
        ...
        public TlsCredentials GetClientCredentials(CertificateRequest certificateRequest)
        {
            ...
            Assert.Equal(clientCertType, context.SecurityParameters.ClientCertificateType);

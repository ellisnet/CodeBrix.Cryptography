...
public class PrfTest
{
    ...
    public void TestLwTls11()
    {
        ...
        Assert.True(Arrays.AreEqual(master_secret, masterSecret.Extract()), "master secret wrong");
        ...
        Assert.True(Arrays.AreEqual(key_block, keyExpansion.Extract()), "key expansion error");
    }

...
public class DtlsTestSuite
{
    ...
    private static void AddFallbackTests(IList<object[]> testSuite)
    {
        {
    ...
    private static void AddVersionTests(IList<object[]> testSuite, ProtocolVersion version)
    {
    ...
    {
        foreach (object[] data in Suite())
        {
            Console.WriteLine((string)data[1]);
            new DtlsTestCase().RunTest((TlsTestConfig)data[0], (string)data[1]);
        }
    }
}

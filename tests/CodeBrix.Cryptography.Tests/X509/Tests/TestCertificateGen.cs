...
namespace CodeBrix.Cryptography.X509.Tests; //was previously: Org.BouncyCastle.X509.Tests;
...
public class TestCertificateGen: SimpleTest
{
    ...
    public void TestRsaDigestSigner()
    {
        ...
        signer.BlockUpdate(msg, 0, msg.Length);
        Assert.True(signer.VerifySignature(sig), "RSA IDigest Signer failed.");
    }
    ...
    public void TestCreationRSA()
    {
        ...
        //Assert.True((cert.IsValidNow && cert.Verify(rsaPublic)), "Certificate failed to be valid (RSA)");
        cert.CheckValidity();
    ...
    public void TestCreationDSA()
    {
        ...
        //Assert.True((cert.IsValidNow && cert.Verify(dsaPub)), "Certificate failed to be valid (DSA Test)");
        cert.CheckValidity();
		cert.Verify(dsaPub);
    ...
    public void TestCreationECDSA()
    {
        ...
        //Assert.True((cert.IsValidNow && cert.Verify(ecPub)), "Certificate failed to be valid (ECDSA)");
        cert.CheckValidity();
		cert.Verify(ecPub);
	...
	public void TestCertLoading()
    {
		...
		try
		{
            Assert.NotNull(new X509CertificateParser().ReadCertificate(cert1));
        }
		catch (Exception)
        {
		...
		try
		{
			Assert.NotNull(new X509CertificateParser().ReadCertificate(cert2));
		}
		catch (Exception)
		{
		...
		try
		{
			Assert.NotNull(new X509CertificateParser().ReadCertificate(cert3));
		}
		catch (Exception)
		{
		...
		try
		{
			Assert.NotNull(new X509CertificateParser().ReadCertificate(cert4));
		}
		catch (Exception)
		{
		...
		try
		{
			Assert.NotNull(new X509CertificateParser().ReadCertificate(cert5));
		}
		catch (Exception)
		{
		...
		try
		{
			Assert.NotNull(new X509CertificateParser().ReadCertificate(cert6));
		}
		catch (Exception)
		{
		...
		try
		{
			Assert.NotNull(new X509CertificateParser().ReadCertificate(cert7));
		}
		catch (Exception)
		{
		...
		try
		{
			Assert.NotNull(new X509CertificateParser().ReadCertificate(oldEcdsa));
		}
		catch (Exception)
		{
		...
		try
		{
			Assert.NotNull(new X509CertificateParser().ReadCertificate(uncompressedPtEC));
		}
		catch (Exception)
		{
		...
		try
		{
			Assert.NotNull(new X509CertificateParser().ReadCertificate(keyUsage));
		}
		catch (Exception)
		{
		...
		try
		{
			Assert.NotNull(new X509CertificateParser().ReadCertificate(nameCert));
		}
		catch (Exception)
		{
		...
		try
		{
			Assert.NotNull(new X509CertificateParser().ReadCertificate(probSelfSignedCert));
		}
		catch (Exception)
		{

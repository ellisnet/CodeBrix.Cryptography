...
public class CrystalsDilithiumTest
{
    ...
    public void TestKeyEncodingDilithium2()
    {
      ...
      Assert.Equal(altEncKey, ((DilithiumPublicKeyParameters)altPubDec).GetEncoded());
      */
        ...
        Assert.Equal(((DilithiumPublicKeyParameters)pub).GetEncoded(), ((DilithiumPublicKeyParameters)pubDec).GetEncoded());
        Assert.Equal(((DilithiumPrivateKeyParameters)priv).GetEncoded(), ((DilithiumPrivateKeyParameters)privDec).GetEncoded());
    }

	...
	: SimpleTest
{
	...
	public override void PerformTest()
	{
        ...
        DoTestWithByteArray(classCast2, "unknown object encountered: CodeBrix.Cryptography.Asn1.DLTaggedObjectParser");
        DoTestWithByteArray(classCast3, "unknown object encountered in constructed OCTET STRING: CodeBrix.Cryptography.Asn1.DLTaggedObject");
